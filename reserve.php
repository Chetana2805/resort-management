...
<div class="conteiner-fluid">
    <form action="" id="reserve-form">
        ...
        <fieldset>
            ...
            <div class="row">
                <div class="col-md-8">
                    <input type="text" name="fullname" class="form-control form-control-sm form-control-border" placeholder="Your Name" required>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <input type="email" name="email" class="form-control form-control-sm form-control-border" placeholder="info@sample.com" required>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <textarea rows="3" name="address" class="form-control form-control-sm" placeholder="Mumbai, Maharashtra 401208" required></textarea>
                </div>
            </div>
        </fieldset>
        <hr>
